...
#             {  3, "Intensité souscrite",                "ISOUSC",      UINT32,       0, C_ANY,   G_ANY,  STATIC_VALUE,  CURRENT,      0x0000, 0x0000,  ZB_NO, ZB_NO,       },
#             {  4, "Puissance Max contrat",              "pref",        UINT32,       0, C_ANY,   G_ANY,  STATIC_VALUE,  POWER_kVA,    0xFF42, 0x002b,  ZB_RO, ZB_UINT16,   },
...
#             { 18, "Période tarifaire en cours",         "PTEC",        STRING,       4, C_ANY,   G_ANY,  STATIC_VALUE,  NONE_CLASS,   0xFF42, 0x0039,  ZB_RP, ZB_CHARSTR,  },
...
#             { 39, "Version de la TIC",                  "VTIC",        STRING,       2, C_ANY,   G_ANY,  STATIC_VALUE,  NONE_CLASS,   0xFF42, 0x002e,  ZB_RO, ZB_CHARSTR,  },
...
#             { 69, "Puissance app. de référence",        "PREF",        UINT16,       0, C_ANY,   G_ANY,  STATIC_VALUE,  POWER_kVA,    0xFF42, 0x002B,  ZB_RO, ZB_UINT16,   },
#             { 70, "Puissance app. de coupure",          "PCOUP",       UINT8,        0, C_ANY,   G_ANY,  STATIC_VALUE,  POWER_kVA,    0x0B01, 0x000E,  ZB_NO, ZB_UINT8,    },
...
#             {105, "Couleur du lendemain",               "demain",      STRING,       9, C_TEMPO, G_ANY,  STATIC_VALUE,  NONE_CLASS,   0xFF42, 0x0003,  ZB_RP, ZB_OCTSTR,   },
