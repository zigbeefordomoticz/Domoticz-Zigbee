...
def sunricher_pir_sensor_sensitivity(self, nwkid, sensitivity):
    self.log.logging("Sunricher", "Log", "sunricher_pir_sensor_sensitivity - Nwkid: %s Mode: %s" % (nwkid, sensitivity))
...
def sunricher_motion_detection_blind_time(self, nwkid, blind_time):
    self.log.logging("Sunricher", "Log", "sunricher_motion_detection_blind_time - Nwkid: %s Mode: %s" %(nwkid, blind_time))
...
def sunricher_motion_detection_pulse_counter(self, nwkid, pulse_setting):
    self.log.logging("Sunricher", "Log", "sunricher_motion_detection_pulse_counter - Nwkid: %s Mode: %s" %(nwkid, pulse_setting))
...
def sunricher_pir_sensor_trigger_time_interval(self, nwkid, trigger_time_interval):
    self.log.logging("Sunricher", "Log", "sunricher_pir_sensor_trigger_time_interval - Nwkid: %s Mode: %s" %(nwkid, sunricher_pir_sensor_trigger_time_interval))
