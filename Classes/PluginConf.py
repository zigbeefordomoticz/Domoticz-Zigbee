...
SETTINGS = { 
    ...
    'PluginTransport':     { 'Order': 10, 'param': {
        ...
        'TimeOut8000':     { 'type':'int', 'default': 1.5 , 'current': None, 'restart':True , 'hidden':False, 'Advanced':True},
        'TimeOut8011':     { 'type':'int', 'default': 7, 'current': None, 'restart':True , 'hidden':False, 'Advanced':True},
        'TimeOutResponse': { 'type':'int', 'default': 7, 'current': None, 'restart':True , 'hidden':False, 'Advanced':True},
        }
    },
