...
SETTINGS = {
    ...
    'PluginTransport':     {'Order': 10, 'param': {
        ...
        'TimeOut8000':     {'type': 'int',  'default': 10,      'current': None, 'restart': False, 'hidden': True,  'Advanced': True},
        ...
        'TimeOutv2':       {'type': 'bool', 'default': 0,      'current': None, 'restart': False, 'hidden': True,  'Advanced': True},
    }
    },
