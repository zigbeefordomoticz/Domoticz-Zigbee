...
SCHNEIDERWISER_MANUF_CODE = 0x105e
SCHNEIDERWISER_MANUF_NAME = 'Schneider Electric'

OTA_MANUF_CODE = ( IKEA_MANUF_CODE, LEDVANCE_MANUF_CODE, OSRAM_MANUF_CODE , LEGRAND_MANUF_CODE, PHILIPS_MANUF_CODE, SCHNEIDERWISER_MANUF_CODE )
