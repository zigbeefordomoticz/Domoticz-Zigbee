...
def LQIreq(self, nwkid='0000'):
    ...
    if nwkid in self.ListOfDevices and 'Health' in self.ListOfDevices[nwkid] and self.ListOfDevices[nwkid]['Health'] == 'Not Reachable':
