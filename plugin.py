...
"""
<plugin key="Zigate" name="Zigate plugin" author="zaraki673 & pipiche38" version="4.0.1" wikilink="http://www.domoticz.com/wiki/Zigate" externallink="https://github.com/sasu-drooz/Domoticz-Zigate/wiki">
    <params>
...
class BasePlugin:
    ...
    def onStart(self):
        Domoticz.Status("onStart called - Zigate plugin V 4.0.1")
