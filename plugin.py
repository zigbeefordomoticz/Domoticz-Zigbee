...
"""
<plugin key="Zigate" name="Zigate plugin" author="zaraki673 & pipiche38" version="4.2.1" wikilink="https://www.domoticz.com/wiki/Zigate" externallink="https://github.com/sasu-drooz/Domoticz-Zigate/wiki">
    <description>
...
class BasePlugin:
    ...
    def onStart(self):
        ...
        Domoticz.Status("Zigate plugin 4.2.1 started")
