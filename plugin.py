...
"""
<plugin key="Zigate" name="Zigate plugin" author="zaraki673 & pipiche38" version="2.4.1" wikilink="http://www.domoticz.com/wiki/Zigate" externallink="https://www.zigate.fr/">
	<params>
...
def Decode8401(self, MsgData) : # Reception Zone status change notification
	...
	if Model == "PST03A-v2.2.5" :
		...
		if MsgEp == "02" :					
			...
			MajDomoDevice(self, MsgSrcAddr, MsgEp, "0500", value)
