...
- **Zigate**: Native support for Zigate coordinators (serial and WiFi).
- **Texas Instruments**: CC2531, CC13x2, CC26x2 (via zigpy-znp). Note: CC253x adapters are obsolete and not recommended.
- **Silicon Labs**: EFR32MGxx chipsets (via zigpy-bellows).
