from Modules.tools import (getSaddrfromIEEE, loggingMessages, timeStamped,
                           updLQI)
from Z4D_decoders.z4d_decoder_helpers import (device_leave_announcement,
                                              device_reset)
...
def Decode8048(self, Devices, MsgData, MsgLQI):
    ...
    if MsgExtAddress not in self.IEEE2NWK:
        device_leave_announcement(self, Devices, MsgExtAddress)
        return
