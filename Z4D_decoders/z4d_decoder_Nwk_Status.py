from Modules.zigbeeController import initLODZigate
...
def Decode8009(self, Devices, MsgData, MsgLQI):
    ...
    if '0000' in self.ListOfDevices and 'CheckChannel' in self.ListOfDevices['0000'] and (self.ListOfDevices['0000']['CheckChannel'] != 0) and self.ListOfDevices['0000']['CheckChannel'] == int(Channel, 16):
