...
from Modules.readAttributes import ReadAttributeRequest_0406_0010, ReadAttributeRequest_0406_0020
...
def common_Ultrasonic_occupancySensibility(self, nwkid, sensibility):
    ...
    if is_sonoff_device(self, nwkid):
        sonoff_set_ultrasonic_occupancySensibility(self, nwkid, sensibility)
