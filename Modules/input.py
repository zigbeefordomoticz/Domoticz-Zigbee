...
def Decode8401( self, Devices, MsgData, MsgLQI ):  # Reception Zone status change notification
    ...
    if MsgSrcAddr not in self.ListOfDevices:
        self.log.logging(  "Input", "Log", "Decode8401 - receive a message for an unknown device %s : %s" % (MsgSrcAddr, MsgData), MsgSrcAddr, )
        return
    ...
    self.log.logging(  "Input", "Debug", "Decode8401 - MsgSQN: %s MsgSrcAddr: %s MsgEp:%s MsgClusterId: %s MsgZoneStatus: %s MsgExtStatus: %s MsgZoneID: %s MsgDelay: %s"
    ...
    if self.ListOfDevices[MsgSrcAddr]["Model"] in ( "3AFE14010402000D", "3AFE28010402000D", 'MOSZB-140', 'TS0202', 'MS01'):  # Konke Motion Sensor, Devlco/Frient Motion
...
def Decode80A7(self, Devices, MsgData, MsgLQI):
    ...
    self.log.logging( "Input", "Debug", "Decode80A7 - SQN: %s, Addr: %s, Ep: %s, Cluster: %s, Cmd: %s, Direction: %s, Unknown_ %s"
    ...
    if MsgClusterId == "0005":
        if MsgDirection not in TYPE_DIRECTIONS:
            ...
            self.log.logging(  "Input", "Log", "Decode80A7 - Addr: %s, Ep: %s, Cluster: %s, Cmd: %s, Direction: %s, Unknown_ %s"
