...
def Decode8010(self, Devices, MsgData, MsgLQI):  # Reception Version list
    ...
    if self.FirmwareBranch in FIRMWARE_BRANCH:
        ...
        if int(self.FirmwareBranch) >= 20:
            ...
            self.pluginParameters["Coordinator"] = "Zigpy-znp, build(20%02d%04d" %( int(self.FirmwareMajorVersion,16), int(self.FirmwareVersion,16))
        ...
        # Zigate Native version
            ...
            self.pluginParameters["Coordinator"] = 'ZiGate Classic PDM (legacy)'
