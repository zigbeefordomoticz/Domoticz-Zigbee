...
def Cluster0702( self, Devices, MsgSQN, MsgSrcAddr, MsgSrcEp, MsgClusterId, MsgAttrID, MsgAttType, MsgAttSize, MsgClusterData ):
    ...
    if MsgAttrID == "0000": 
        ...
        Domoticz.Debug("ReadCluster0702 - %s/%s Attribute %s: %s" %(MsgSrcAddr, MsgSrcEp, MsgAttrID,value))
...
def Cluster0300( self, Devices, MsgSQN, MsgSrcAddr, MsgSrcEp, MsgClusterId, MsgAttrID, MsgAttType, MsgAttSize, MsgClusterData ):
    ...
    if MsgAttrID == "0000":     # CurrentHue
        ...
        Domoticz.Debug("ReadCluster0300 - %s/%s RemainingTime: %s" %(MsgSrcAddr, MsgSrcEp, value))
...
def Cluster0101( self, Devices, MsgSQN, MsgSrcAddr, MsgSrcEp, MsgClusterId, MsgAttrID, MsgAttType, MsgAttSize, MsgClusterData ):
    ...
    Domoticz.Debug("ReadCluster 0101 - Dev: %s, EP:%s AttrID: %s, AttrType: %s, AttrSize: %s Attribute: %s" \
            %( MsgSrcAddr, MsgSrcEp, MsgAttrID, MsgAttType, MsgAttSize, MsgClusterData))

    if MsgAttrID == "0000":          # Lockstate
        Domoticz.Debug("ReadCluster 0101 - Dev: Lock state " +str(MsgClusterData) )

    elif MsgAttrID == "0001":         # Locktype
        Domoticz.Debug("ReadCluster 0101 - Dev: Lock type "  + str(MsgClusterData))

    elif MsgAttrID == "0002":         # Enabled
        Domoticz.Debug("ReadCluster 0101 - Dev: Enabled "  + str(MsgClusterData))

    elif MsgAttrID ==  "0055":   # Aqara Vibration
        Domoticz.Debug("ReadCluster %s/%s - Aqara Vibration - Event: %s" %(MsgClusterId, MsgAttrID, MsgClusterData) )
        ...
        Domoticz.Debug("ReadCluster %s/%s -  Vibration Angle - Attribute: %s" %(MsgClusterId, MsgAttrID, MsgClusterData) )
        ...
        Domoticz.Debug("ReadCluster %s/%s -  Vibration Strenght - Attribute: %s" %(MsgClusterId, MsgAttrID, MsgClusterData) )
        ...
        if  z+y != 0 and x+z != 0 and x+y != 0:
            ...
            Domoticz.Debug("ReadCluster %s/%s -  Vibration Orientation - 0x%16x - x=%d, y=%d, z=%d" \
...
def Cluster0000( self, Devices, MsgSQN, MsgSrcAddr, MsgSrcEp, MsgClusterId, MsgAttrID, MsgAttType, MsgAttSize, MsgClusterData ):
    ...
    if MsgAttrID == "0000": # ZCL Version
            ...
            if modelName != '':
                ...
                if 'Model' in self.ListOfDevices[MsgSrcAddr]:
                    if self.ListOfDevices[MsgSrcAddr]['Model'] == modelName and self.ListOfDevices[MsgSrcAddr]['Model'] in self.DeviceConf:
                        Domoticz.Debug("ReadCluster - %s / %s - no action" %(MsgClusterId, MsgAttrID))
                        return
                else:
        ...
        Domoticz.Debug("ReadCluster - Attribute 0008: " +str(decodeAttribute( MsgAttType, MsgClusterData) ))

    elif MsgAttrID == '0009': # 
        Domoticz.Debug("ReadCluster - Attribute 0009: " +str(decodeAttribute( MsgAttType, MsgClusterData) ))
...
def Cluster0012( self, Devices, MsgSQN, MsgSrcAddr, MsgSrcEp, MsgClusterId, MsgAttrID, MsgAttType, MsgAttSize, MsgClusterData ):
    ...
    if self.ListOfDevices[MsgSrcAddr]['Model'] in ( 'lumi.remote.b1acn01', \
        ...
        value = decodeAttribute( MsgAttType, MsgClusterData )
        Domoticz.Debug("ReadCluster - ClusterId=0012 - Switch Aqara (AQ2): EP: %s Value: %s " %(MsgSrcEp,value))
        value = int(value)
        MajDomoDevice(self, Devices, MsgSrcAddr, MsgSrcEp, "0006",str(value))    # Force ClusterType Switch in order to behave as 
        ...
        value = decodeAttribute( MsgAttType, MsgClusterData )
        value = int(value)
        Domoticz.Debug("ReadCluster - ClusterId=0012 - Switch Aqara lumi.ctrl_ln2.aq1: EP: %s Attr: %s Value: %s " %(MsgSrcEp,MsgAttrID, value))
...
def Cluster0201( self, Devices, MsgSQN, MsgSrcAddr, MsgSrcEp, MsgClusterId, MsgAttrID, MsgAttType, MsgAttSize, MsgClusterData ):
    ...
    if MsgAttrID =='0000':  # Local Temperature (Zint16)
        ...
        if int(value) in SYSTEM_MODE:
            Domoticz.Debug("ReadCluster 0201 - System Mode: %s / %s" %(value, SYSTEM_MODE[value]))
        else:
            Domoticz.Debug("ReadCluster 0201 - Attribute 1C: %s" %value)


    elif MsgAttrID == '0403':
        Domoticz.Debug("ReadCluster 0201 - Attribute 403: %s" %value)

    elif MsgAttrID == '0408':
        value = int(decodeAttribute( MsgAttType, MsgClusterData))
        Domoticz.Debug("ReadCluster 0201 - Attribute 408: %s" %value)

    elif MsgAttrID == '0409':
        value = int(decodeAttribute( MsgAttType, MsgClusterData))
        Domoticz.Debug("ReadCluster 0201 - Attribute 409: %s" %value)

    elif MsgAttrID == '4000': # TRV Mode
        Domoticz.Debug("ReadCluster 0201 - TRV Mode: %s" %value)

    elif MsgAttrID == '4001': # Valve position
        Domoticz.Debug("ReadCluster 0201 - Valve position: %s" %value)
...
def Cluster0204( self, Devices, MsgSQN, MsgSrcAddr, MsgSrcEp, MsgClusterId, MsgAttrID, MsgAttType, MsgAttSize, MsgClusterData ):
    ...
    Domoticz.Debug("ReadCluster 0204 - Addr: %s Ep: %s AttrId: %s AttrType: %s AttSize: %s Data: %s"
            %(MsgSrcAddr, MsgSrcEp, MsgAttrID, MsgAttType, MsgAttSize, MsgClusterData))
...
def Clusterfc00( self, Devices, MsgSQN, MsgSrcAddr, MsgSrcEp, MsgClusterId, MsgAttrID, MsgAttType, MsgAttSize, MsgClusterData ):
    ...
    if MsgAttrID == '0001': #On button
        ...
        if action in ('00'): #Short press
            ...
            Domoticz.Debug("ReadCluster - %s - %s/%s - DIM Release after %s seconds" %(MsgClusterId, MsgSrcAddr, MsgSrcEp, round(duration/10)))
