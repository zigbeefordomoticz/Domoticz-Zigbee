...
ZIGATE_COMMANDS = {
    ...
    0x0043: {'Sequence': (0x8000, 0x8043), 'Ack': True, 'SQN': True,  'Layer': 'ZDP',    'Command': 'Simple Descriptor request', 'NwkId 2nd Bytes': False},
    0x0044: {'Sequence': (0x8000, 0x7044), 'Ack': True, 'SQN': True,  'Layer': 'ZDP',    'Command': 'Power Descriptor request', 'NwkId 2nd Bytes': False},
    0x0045: {'Sequence': (0x8000, 0x8045), 'Ack': True, 'SQN': True,  'Layer': 'ZDP',    'Command': 'Active Endpoint request', 'NwkId 2nd Bytes': False},
    0x0046: {'Sequence': (0x8000, 0x8046), 'Ack': True, 'SQN': True,  'Layer': 'ZDP',    'Command': 'Match Descriptor request', 'NwkId 2nd Bytes': False},
    0x0047: {'Sequence': (0x8000, 0x8047), 'Ack': True, 'SQN': True,  'Layer': 'ZDP',    'Command': 'Management Leave request', 'NwkId 2nd Bytes': False},
    0x0049: {'Sequence': (0x8000, 0x8049), 'Ack': False, 'SQN': True,  'Layer': 'ZDP',    'Command': 'Permit Joining request', 'NwkId 2nd Bytes': False},
    0x004A: {'Sequence': (0x8000, 0x804A), 'Ack': False, 'SQN': True,  'Layer': 'ZDP',    'Command': 'Management Network Update request', 'NwkId 2nd Bytes': False},
    0x004B: {'Sequence': (0x8000, 0x804B), 'Ack': True, 'SQN': True,  'Layer': 'ZDP',    'Command': 'System Server Discovery request', 'NwkId 2nd Bytes': False},
    0x004C: {'Sequence': (0x8000, 0x804C), 'Ack': False, 'SQN': True,  'Layer': 'ZDP',    'Command': 'E_SL_MSG_LEAVE_REQUEST', 'NwkId 2nd Bytes': False},
    0x004D: {'Sequence': (0x8000, 0x804D), 'Ack': False, 'SQN': True,  'Layer': 'ZDP',    'Command': 'E_SL_MSG_DEVICE_ANNOUNCE', 'NwkId 2nd Bytes': False},
    0x004E: {'Sequence': (0x8000, 0x804E), 'Ack': True, 'SQN': True,  'Layer': 'ZDP',    'Command': 'Management LQI request', 'NwkId 2nd Bytes': False},
    0x004F: {'Sequence': (0x8000, 0x804F), 'Ack': False, 'SQN': True,  'Layer': 'ZDP',    'Command': 'E_SL_MSG_DEVICE_ANNOUNCE', 'NwkId 2nd Bytes': False},
    0x0050: {'Sequence': (0x8000, 0x8050), 'Ack': False, 'SQN': False, 'Layer': 'ZDP',  'Command': 'E_SL_MSG_BASIC_RESET_TO_FACTORY_DEFAULTS', 'NwkId 2nd Bytes': False},

    # Group
    0x0060: {'Sequence': (0x8000, 0x8060),  'Ack': True, 'SQN': True, 'Layer': 'ZCL',    'Command': 'Group Add', 'NwkId 2nd Bytes': True},
    ...
    # Action Hue
    0x00B0: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Move to Hue', 'NwkId 2nd Bytes': True},
    0x00B1: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Move Hue', 'NwkId 2nd Bytes': True},
    0x00B2: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Step Hue', 'NwkId 2nd Bytes': True},
    0x00B3: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Move to saturation', 'NwkId 2nd Bytes': True},
    0x00B4: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Move saturation', 'NwkId 2nd Bytes': True},
    0x00B5: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Step saturation', 'NwkId 2nd Bytes': True},
    0x00B6: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Move to hue and saturation', 'NwkId 2nd Bytes': True},
    0x00B7: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Move to colour', 'NwkId 2nd Bytes': True},
    0x00B8: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Move colour', 'NwkId 2nd Bytes': True},
    0x00B9: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Step Colour', 'NwkId 2nd Bytes': True},
    0x00BA: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Enhaced Move to Hue', 'NwkId 2nd Bytes': True},
    0x00BB: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Enhanced Move Hue', 'NwkId 2nd Bytes': True},
    0x00BC: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Enhanced Step Hue', 'NwkId 2nd Bytes': True},
    0x00BD: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Enhanced Move to hue and saturation', 'NwkId 2nd Bytes': True},
    0x00BE: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Colour Loop Set', 'NwkId 2nd Bytes': True},
    0x00BF: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Stop Move Step', 'NwkId 2nd Bytes': True},

    # Action Color
    0x00C0: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Move to colour temperature', 'NwkId 2nd Bytes': True},
    0x00C1: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'Move colour temperature', 'NwkId 2nd Bytes': True},
    ...
    0x00F0: {'Sequence': (0x8000, ),       'Ack': True,  'SQN': False, 'Layer': 'ZCL', 'Command': 'Lock Unlock door', 'NwkId 2nd Bytes': True},
    ...
    0x0150: {'Sequence': (0x8000, 0x8150), 'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'E_SL_MSG_ATTRIBUTE_EXT_DISCOVERY_REQUEST', 'NwkId 2nd Bytes': True},
    0x0160: {'Sequence': (0x8000, 0x8160), 'Ack': True, 'SQN': False, 'Layer': 'ZCL', 'Command': 'E_SL_MSG_COMMAND_RECEIVED_DISCOVERY_REQUEST', 'NwkId 2nd Bytes': True},
    ...
    0x0530: {'Sequence': (0x8000, ),       'Ack': True, 'SQN': True,  'Layer': 'ZDP', 'Command': 'Raw APS Data Request', 'NwkId 2nd Bytes': False},
