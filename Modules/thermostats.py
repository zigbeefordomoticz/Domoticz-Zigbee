...
def thermostat_Calibration(self, NwkId, calibration=None):
    ...
    if calibration < -25 or calibration > 25:
        self.log.logging(
            "Thermostats",
            "Error",
            "thermostat_Calibration - Wrong Calibration offset on %s off %s" % (NwkId, calibration),
        )
        calibration = 0
    ...
    if calibration < 0:
        ...
        self.log.logging(
            "Thermostats",
            "Debug",
            "thermostat_Calibration - 2 complement form of Calibration offset on %s off %s" % (NwkId, calibration),
        )
