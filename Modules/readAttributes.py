...
def ReadAttributeRequest_0406_sonoff_0022(self, key):
    manufacturer = "100b"
    self.log.logging("ReadAttributes", "Debug", "ReadAttributeRequest_0406_sonoff_0022/0010- Key: %s " % key, nwkid=key)
    ListOfEp = getListOfEpForCluster(self, key, "0406")
    listAttrSpecific = [0x0022]
    for EPout in ListOfEp:
        ReadAttributeReq(
            self,
            key,
