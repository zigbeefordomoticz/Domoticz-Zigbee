...
def schneider_hact_heater_type_wiser2(self, nwkid: str, type_heater: str) -> None:
    ...
    self.log.logging( "Schneider", "Debug", "Writing attribute with params: CLUSTER=%s, MANUF_ID=%s, ATTRIBUTE=%s, VALUE=%s" % (
        SCHNEIDER_SPECIFIC_PILOT_MODE_CLUSTER, SCHNEIDER_MANUF_ID, PILOT_MODE_ATTRIBUTE, pilot_mode), nwkid=nwkid)
